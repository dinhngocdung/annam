...
function checkSearchHTML(){	
	...
	{
		alert("Rentrez un mot pour effectuer une recherche");
		form.search_txt.focus();
		return false;
	}
	else if(form.search_char.checked == false && form.search_table.checked == false)
	{
		alert("Sélectionnez une ou des catégorie(s) de recherche");
		return false;
	}
	else
	{
...
function searchWordToWord(text)
{
	...
	{
		document.getElementById('gridWithScroll').innerHTML = "<i> Aucun résultat.</i>";
	}
}
...
function displayTable(display_array)
{
	...
	for(o in display_array)
	{
		...
		table_string += "<tr><td width='90%'>&nbsp;&nbsp;&nbsp;<a href='view_page/view"+ display_array[o][0] +".html' onclick='changeViewFrame(); loadPageHeader();' target='view_page' class='tableColor'>" + display_array[o][1] + "</a></td>";
...
function displayCharacter(display_array)
{
	...
	for(o in display_array)
	{
		...
		table_string += "<tr><td width='90%'>&nbsp;&nbsp;&nbsp;<a href='view_page/view"+ display_array[o][0] +".html' onclick='changeViewFrame(); loadPageHeader();' target='view_page' class='charColor'>" + display_array[o][1] + "</a></td>";
		table_string += "<td width='10%' align='left'> "+ display_array[o][0] + "</td></tr>";
	}
	table_string += "</table>";
	document.getElementById('gridWithScroll').innerHTML = table_string;
...
function displayTableAndCharacter(display_array_char, display_array,temp_char_table_array)
{
	...
	for(o in temp_char_table_array)
	{
		...
		{
			table_string += "<tr><td width='90%'>&nbsp;&nbsp;&nbsp;<a href='view_page/view"+ display_array_char[char_no][0] +".html' onclick='changeViewFrame(); loadPageHeader();' target='view_page' class='charColor'>" + display_array_char[char_no][1] + "</a></td>";
			table_string += "<td width='10%' align='left'> "+ display_array_char[char_no][0] + "</td></tr>";
			char_no++;
		}
		else // table analytic
		{
			table_string += "<tr><td width='90%'>&nbsp;&nbsp;&nbsp;<a href='view_page/view"+ display_array[table_no][0] +".html' onclick='changeViewFrame(); loadPageHeader();' target='view_page' class='tableColor'>" + display_array[table_no][1] + "</a></td>";
