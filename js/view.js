...
function fnElementFade(elm, show)
{
 ...
 elm._f_count = Math.max(0, Math.min(75, elm._f_count + speed*(show?1:-1)));
...
function fnContainerSetA(container, active)
{
 // Sets the "activated" status of a note container area, and changes
 // the appropriate "toggle" item in its control bar.
...
function fnClickHandler(evt)
{
 ...
 while (node && !((node.className||'').indexOf('fn-container') > -1))
 {
  ...
  if((/fn-controlbar-zoom/).test(node.className))
  {
	  var container = fnGetContainer(node);
	   if (container)
	   {
		...
		if((document.getElementById('changeStyle').className == "fn-controlbar-toggle-active") && isActive == true)
		{
			fnContainerSetA(container, !isActive);
		}
...
var zoomLevel = 1.00;
	...
	var importNo = 0;
 	function loadHeight(){
		var count0 = document.images_test.zoom.height;
		var count = document.images_test.zoom.height * 50 /100;
		//document.getElementById('container1').style.height= count0;
		//document.getElementById('zoomContainer').style.height= count0;		
		//document.getElementById('zoom').style.height= count0;
		document.getElementById('container1').style.height= 600;
		document.getElementById('zoomContainer').style.height= 600;		
		document.getElementById('zoom').style.height= 600;
		document.getElementById('zoom').style.width = 800;
		//document.getElementById('zoom').style.height= 600;
		oHeight = document.images_test.zoom.height; oWidth = document.images_test.zoom.width;
		...
		if (ff3){
			...
			document.getElementById("container1").onclick = "";
		} else if (ie7){
			document.getElementById("container1").onclick = "";		
		}else{
		...
		if(string_check != "")
		{
			//document.getElementById("searchPage").innerHTML = "" + string_check;
			//document.getElementById("zoom").src = "test_images/OGER_Page_"+ changeTypeNum(string_check) +".jpg";
			//document.getElementById("rememberImageNum").value = ""+ string_check;
		}
		else
		{
			//document.getElementById("searchPage").innerHTML = "1";
			//document.getElementById("zoom").src = "test_images/OGER_Page_001.jpg";			
			//document.getElementById("rememberImageNum").value = "1";
		}
		//checkImagePosition();
	}
	...
	{
		//document.getElementById("searchPage").innerHTML = "" + parseInt(image);
		//document.getElementById("zoom").src = "test_images/OGER_Page_"+ image +".jpg";
		//document.getElementById("rememberImageNum").value = parseInt(image);
	}
	...
	function zoomIn(){
		...
		zoomLevel += .1;
		document.getElementById('zoomContainer').style.zIndex = "5";
		document.getElementById('zoom').style.zIndex = "1";
		if (zoomLevel > MAX_ZOOM){
			...
			document.getElementById('zoom').style.height = zoomLevel * oHeight;
			
			// calculate new left / top
			var newLeft=  ((zoomLevel * width) - width) / 2;
			var newTop =  ((zoomLevel * oHeight) - oHeight) / 2;
			pos.x = newLeft;
			pos.y = newTop;
	...
	function zoomOut(x, y){
		zoomLevel -= .1;
		document.getElementById('zoomContainer').style.cursor = "default";
		document.getElementById('zoomContainer').style.zIndex = "0";
		...
		var percent = ( (zoomLevel - MIN_ZOOM) *  100 ) ;
		// calculate new left
	...
	function toggleZoom() {
		...
		if (zoomed){
			...
			document.getElementById('zoomContainer').style.cursor = "move";
			zoomIn();			
		}
	...
	function changeStyle(){
		if(document.getElementById('changeZoom').className == "fn-controlbar-zoom-active")
		{
			document.getElementById('changeZoom').className = "fn-controlbar-zoom-inactive";
		}
		else
		{
			document.getElementById('changeZoom').className = "fn-controlbar-zoom-active";
		}
		if(document.getElementById('changeStyle').className == "fn-controlbar-toggle-inactive")
		{
			document.getElementById('changeStyle').className = "fn-controlbar-toggle-active";
		}	
	...
	function move(e){
		...
		var actualHeight = (zoomLevel * oHeight) - 0;
		...
		if (newTop <= 0 && ( (newTop + actualHeight) > (oHeight )) ) {
			document.getElementById('zoom').style.top  = newTop;
		}
		
		var top1 = document.getElementById('zoom').style.top.replace('px','')  ;
	...
	{
		if(document.getElementById('changeZoom').className == "fn-controlbar-zoom-inactive")
		{
			document.getElementById('changeZoom').className = "fn-controlbar-zoom-active";
		}
	}
	...
	{
		var imageNum_string = document.getElementById("rememberImageNum").value;
		var decreaseNum = parseInt(imageNum_string) - 1;
		document.getElementById("rememberImageNum").value = "" + decreaseNum;
		document.getElementById("searchPage").innerHTML = "" + decreaseNum;		
		document.getElementById("zoom").src = "test_images/OGER_Page_"+ changeTypeNum(decreaseNum) +".jpg";
		//checkImagePosition();
	}
	
	function increaseImage()
	{
		var imageNum_string1 = document.getElementById("rememberImageNum").value;
		var increaseNum = parseInt(imageNum_string1) + 1;
		document.getElementById("rememberImageNum").value = "" + increaseNum;
		document.getElementById("searchPage").innerHTML = "" + increaseNum ;
		document.getElementById("zoom").src = "test_images/OGER_Page_"+ changeTypeNum(increaseNum) +".jpg";
		//checkImagePosition();
	}
	
	function changeTypeNum(number)
	{
		var change_type = "";
		if(number <10)
		{
			change_type = "00" + number;
		}
		else if(number <100)
		{ 
			change_type = "0" + number;
		}
		else
		{
			change_type = "" + number;
	...
	{
		var imageNum = parseInt(document.getElementById("rememberImageNum").value);
		if(imageNum == 1)
		{
